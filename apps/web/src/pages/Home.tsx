        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-xl">
            ...
            <p className="text-lg text-gray-100 mb-8 font-medium">
              Discover our curated collection of premium electronics designed for professionals who
              demand the best.
            </p>
            <Link
              to="/products"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link
              to="/products"
              className="text-gray-900 font-semibold flex items-center gap-2 hover:underline"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link
              ...
              className="group block relative h-80 bg-gray-100 overflow-hidden"
            >
            ...
            {trendingProducts.length > 0 ? (
              trendingProducts.map((product) => (
                ...
                >
                  ...
                  <h3 className="text-sm font-bold text-gray-900 mb-1 group-hover:underline">
                    {product.name}
                  </h3>
